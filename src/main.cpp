...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xocaml " << XEUS_OCAML_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xocaml
    ...
    using interpreter_ptr = std::unique_ptr<xeus_ocaml::interpreter>;
    interpreter_ptr interpreter = interpreter_ptr(new xeus_ocaml::interpreter());
