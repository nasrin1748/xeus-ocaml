...
(function
  (globalThis){
   ...
   Stdlib_Callback[2].call
    (null, cst_Graphics_Graphic_failure, [0, Graphic_failure, cst]);
   function unix_open_graph(arg){
    caml_gr_sigio_signal(0);
   ...
   if(match !== "Cygwin")
    if(match !== "MacOS")
     if(match !== "Unix")
      if(match !== "Win32")
       var
        c = Stdlib[28].call(null, cst_Graphics_unknown_OS_type, Stdlib_Sys[4]),
        a = Stdlib[1].call(null, c),
        close_graph = a[2],
        open_graph = a[1];
      else
       var
        close_graph = function(a){return caml_gr_close_graph(a);},
        open_graph = caml_gr_open_graph;
     else
   ...
   function plots(points){
    var a = points.length - 2 | 0, b = 0;
    if(a >= 0){
     var i = b;
     for(;;){
      var
       match = caml_check_bound(points, i)[i + 1],
       y = match[2],
       x = match[1];
   ...
   function current_point(param){
    var a = caml_gr_current_y(0);
    return [0, caml_gr_current_x(0), a];
   }
   function rlineto(x, y){
    var a = caml_gr_current_y(0) + y | 0;
    return caml_gr_lineto(caml_gr_current_x(0) + x | 0, a);
   }
   function rmoveto(x, y){
    var a = caml_gr_current_y(0) + y | 0;
    return caml_gr_moveto(caml_gr_current_x(0) + x | 0, a);
   }
   function draw_rect(x, y, w, h){
    if(0 <= w && 0 <= h) return runtime.caml_gr_draw_rect(x, y, w, h);
    throw caml_maybe_attach_backtrace([0, Stdlib[6], cst_draw_rect], 1);
   }
   function dodraw(close_flag, points){
    var a = 0 < points.length - 1 ? 1 : 0;
    if(a){
     var
      match = current_point(0),
      savey = match[2],
      savex = match[1],
      d = caml_check_bound(points, 0)[1][2];
     caml_gr_moveto(points[1][1], d);
     var b = points.length - 2 | 0, e = 1;
     if(b >= 1){
      var i = e;
      for(;;){
       var
        match$0 = caml_check_bound(points, i)[i + 1],
        y = match$0[2],
        x = match$0[1];
       caml_gr_lineto(x, y);
       var g = i + 1 | 0;
     ...
     if(close_flag){
      var f = caml_check_bound(points, 0)[1][2];
      caml_gr_lineto(points[1][1], f);
     }
     var c = caml_gr_moveto(savex, savey);
    }
    else
     var c = a;
    return c;
   ...
   var b = 0;
   function draw_poly_line(a){return dodraw(b, a);}
   var d = 1;
   function draw_poly(a){return dodraw(d, a);}
   function draw_segments(segs){
    ...
    if(a >= 0){
     ...
     for(;;){
      var
       match$0 = caml_check_bound(segs, i)[i + 1],
       y2 = match$0[4],
       x2 = match$0[3],
       y1 = match$0[2],
       x1 = match$0[1];
   ...
   function draw_arc(x, y, rx, ry, a1, a2){
    if(0 <= rx && 0 <= ry)
     return runtime.caml_gr_draw_arc(x, y, rx, ry, a1, a2);
    throw caml_maybe_attach_backtrace
           ([0, Stdlib[6], cst_draw_arc_ellipse_circle], 1);
   }
   ...
   function set_line_width(w){
    ...
    throw caml_maybe_attach_backtrace([0, Stdlib[6], cst_set_line_width], 1);
   }
   function fill_rect(x, y, w, h){
    if(0 <= w && 0 <= h) return runtime.caml_gr_fill_rect(x, y, w, h);
    throw caml_maybe_attach_backtrace([0, Stdlib[6], cst_fill_rect], 1);
   }
   function fill_arc(x, y, rx, ry, a1, a2){
    if(0 <= rx && 0 <= ry)
     return runtime.caml_gr_fill_arc(x, y, rx, ry, a1, a2);
    throw caml_maybe_attach_backtrace
           ([0, Stdlib[6], cst_fill_arc_ellipse_circle], 1);
   }
   ...
   function mouse_pos(param){
    var e$0 = caml_gr_wait_event(e);
    return [0, e$0[1], e$0[2]];
   }
   function button_down(param){var e = caml_gr_wait_event(f); return e[3];}
   function read_key(param){var e = caml_gr_wait_event(g); return e[5];}
   function key_pressed(param){var e = caml_gr_wait_event(h); return e[4];}
   function loop_at_exit(events, handler){
    var
     events$0 =
       Stdlib_List[41].call(null, function(e){return 4 !== e ? 1 : 0;})
        (events);
    return Stdlib[100].call
            (null,
             function(param){
              try{
               for(;;){
                var e$0 = caml_gr_wait_event(events$0);
                caml_call1(handler, e$0);
               }
              }
              catch(e$0){
   ...
   function sub(param, a){
    var y2 = a[2], x2 = a[1], y1 = param[2], x1 = param[1];
    return [0, x1 - x2, y1 - y2];
   }
   function middle(param, a){
    var y2 = a[2], x2 = a[1], y1 = param[2], x1 = param[1];
    return [0, (x1 + x2) / 2., (y1 + y2) / 2.];
   }
   function area(param, a){
    var y2 = a[2], x2 = a[1], y1 = param[2], x1 = param[1];
    return Math.abs(x1 * y2 - x2 * y1);
   }
   function curveto(b$0, c, d){
    var y = d[2], x = d[1];
    ...
    function int_point(param){
     var y = param[2], x = param[1], a = round(y);
     return [0, round(x), a];
    }
    var
     d$0 = float_point(d),
    ...
    function spl(accu$1, a$1, b$1, c$1, d$0){
     var accu = accu$1, a = a$1, b = b$1, c = c$1;
     for(;;){
      var
       v = sub(d$0, a),
       y1 = v[2],
       ...
       e = area(v, sub(a, b)) <= s ? 1 : 0,
       f = e ? area(v, sub(a, c)) <= s ? 1 : 0 : e;
      if(f) return [0, d$0, accu];
      var
       a$0 = middle(a, b),
       o = middle(b, c),
       b$0 = middle(a$0, o),
    ...
    var
     points = spl([0, a, 0], a, b$1, c$0, d$0),
     e = Stdlib_List[19].call(null, int_point, points);
    dodraw(b, Stdlib_Array[12].call(null, e));
  ...
  (globalThis){
   ...
   runtime.jsoo_create_file
    ("/static/cmis/graphicsX11.cmi",
     "Caml1999I031\x84\x95\xa6\xbe\0\0\x01\xfe\0\0\0h\0\0\x01\x8e\0\0\x01\x80\xa0+GraphicsX11\xa0\xc1\xa0)window_id\x01\x01\x0f\b\0\x008\0@@@A\x90\xc0\xb3\x90\xa3&stringO@\x90@\x02\x05\xf5\xe1\0@\0\xef@@@@\xb0\xc08src/unix/graphicsX11.mliR\x01\x04\x97\x01\x04\x97\xc0\x04\x02R\x01\x04\x97\x01\x04\xae@@@@\xa1\x04\x12@A@\xa0\xb0\xa0)window_id\x01\x01\x10\xd0\xc0\xc1@\xc0\xb3\x90\xa3$unitF@\x90@\x02\x05\xf5\xe1\0@\0\xf0\xc0\xb3\x90\x04\x1f@\x90@\x02\x05\xf5\xe1\0@\0\xf1@\x02\x05\xf5\xe1\0@\0\xf2@\xb0\xc0\x04\x16T\x01\x04\xb0\x01\x04\xb0\xc0\x04\x17T\x01\x04\xb0\x01\x04\xd1@@\xa1\x04'A@\xa0\xb0\xa0.open_subwindow\x01\x01\x11\xd0\xc0\xc1\x90!x\xc0\xb3\x90\xa3#intA@\x90@\x02\x05\xf5\xe1\0@\0\xf3\xc0\xc1\x90!y\xc0\xb3\x90\x04\n@\x90@\x02\x05\xf5\xe1\0@\0\xf4\xc0\xc1\x90%width\xc0\xb3\x90\x04\x12@\x90@\x02\x05\xf5\xe1\0@\0\xf5\xc0\xc1\x90&height\xc0\xb3\x90\x04\x1a@\x90@\x02\x05\xf5\xe1\0@\0\xf6\xc0\xb3\x04/@\x90@\x02\x05\xf5\xe1\0@\0\xf7@\x02\x05\xf5\xe1\0@\0\xf8@\x02\x05\xf5\xe1\0@\0\xf9@\x02\x05\xf5\xe1\0@\0\xfa@\x02\x05\xf5\xe1\0@\0\xfb@\xb0\xc0\x04DY\x01\x05_\x01\x05_\xc0\x04EY\x01\x05_\x01\x05\xaa@@\xa1\x04UB@\xa0\xb0\xa0/close_subwindow\x01\x01\x12\xd0\xc0\xc1@\xc0\xb3\x04=@\x90@\x02\x05\xf5\xe1\0@\0\xfc\xc0\xb3\x90\x04F@\x90@\x02\x05\xf5\xe1\0@\0\xfd@\x02\x05\xf5\xe1\0@\0\xfe@\xb0\xc0\x04V]\x01\x06\n\x01\x06\n\xc0\x04W]\x01\x06\n\x01\x061@@\xa1\x04gC@@\x84\x95\xa6\xbe\0\0\0i\0\0\0\x0f\0\0\x009\0\0\0.\xa0\xa0+GraphicsX11\x900\xc0\xbaH\xfd\x9b\xd0%\xfb\x110\xbb\n\xa3\x1eRV\xa0\xa0&Stdlib\x900y\xb0\xe9\xd3\xb6\xf7\xfe\xd0~\xb3\xcc*\xbb\x96\x1b\x91\xa0\xa08CamlinternalFormatBasics\x900\x8f\x8fcEXy\x8e\xe4\b\xdf<P\xa5S\x9b\x15@\x84\x95\xa6\xbe\0\0\0\x04\0\0\0\x02\0\0\0\x05\0\0\0\x05\xa0\x90@@");
   var
    global_data = runtime.caml_get_global_data(),
    Stdlib_Hashtbl = global_data.Stdlib__Hashtbl,
    Stdlib = global_data.Stdlib,
    Graphics = global_data.Graphics,
    subwindows = Stdlib_Hashtbl[1].call(null, 0, 13),
   ...
   function open_subwindow(x, y, width, height){
    ...
    Stdlib_Hashtbl[5].call(null, subwindows, wid, 0);
    return wid;
   }
   function close_subwindow(wid){
    if(Stdlib_Hashtbl[9].call(null, subwindows, wid)){
     runtime.caml_gr_close_subwindow(wid);
     return Stdlib_Hashtbl[10].call(null, subwindows, wid);
    }
    var a = Stdlib[28].call(null, cst_close_subwindow_no_such_su, wid);
    throw caml_maybe_attach_backtrace([0, Graphics[1], a], 1);
   }
   var
    GraphicsX11 =
...
//# sourceMappingURL=data:application/json;base64,
